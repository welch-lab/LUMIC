...
class IncBase(object):
    ...
    def __init__(self, batch_size, node_fdim, edge_fdim, max_nodes=150, max_edges=200, max_nb=12):
        self.max_nb = max_nb
...
class IncTree(IncBase):
    ...
    def __init__(self, batch_size, node_fdim, edge_fdim, max_nodes=150, max_edges=200, max_nb=12, max_sub_nodes=50):
        # print("LLL", max_sub_nodes)
